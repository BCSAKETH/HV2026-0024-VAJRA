...
- **Twilio is for consumers only** (WhatsApp receipts + delivery OTP) — never for staff login. Twilio Sandbox numbers only deliver to phones that have first texted the sandbox its join code — pre-join your demo phones before presenting.
